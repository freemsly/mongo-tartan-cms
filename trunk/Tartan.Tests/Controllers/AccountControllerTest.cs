...
namespace Tartan.Tests.Controllers
{
	...
	public class AccountControllerTest
	{
		...
		private static AccountController GetAccountController()
		{
			...
			AccountController controller = new AccountController(new MockTartanService())
			{
		...
		private class MockTartanService : ITartanService
		{
			public System.Collections.Generic.List<PageModel> PageList
			{
				get { return new List<PageModel>(); }
			}

			public IFormsAuthenticationService FormsService
			{
				get { return new MockFormsAuthenticationService(); }
			}

			public IMembershipService MembershipService
			{
				get { return new AccountMembershipService(); }
			}
		}
		...
		private class MockMembershipService : Tartan.Controllers.IMembershipService
		{
